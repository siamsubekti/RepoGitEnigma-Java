...
public class Person {
	...
	public Person(Integer id, String name, String birthdate, Gender gender) throws ParseException {
		this.id = id;
		this.name = name;
	...
	public List<Person> getMutualFriends(Person friend) {
		...
		for(Person myFriend: this.friends) {
			if (friend.getFriends().contains(myFriend)) {
