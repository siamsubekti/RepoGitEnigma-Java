...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <% 
		Category category = (Category) request.getAttribute("updatecate"); 
		%>
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				...
				<a class="nav-link" href="/friends-servlet/ListAllCategory">Back to List
	...
	<div class="row">
			<div class="col-10">
				<h1
					style="text-align: center; font-family: cursive; font-style: oblique;">Edit Category</h1>
			</div>
		</div>
