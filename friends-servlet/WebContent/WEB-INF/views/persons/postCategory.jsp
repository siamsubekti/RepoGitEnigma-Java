...
<title>Post By Id Category</title>
</head>
<body>
	<div class="row">
			<div class="col-10">
				<h1
					style="text-align: center; font-family: cursive; font-style: oblique;">Post By Id Category</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-10">
				<div class="table-responsive">
					<table class="table table-dark table-striped table-hover">
						...
						<tbody>
						<% 
						for(Post  perpost :(List<Post>) request.getAttribute("postcat")){
						%>
						<tr>
